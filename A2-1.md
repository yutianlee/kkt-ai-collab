...
### Lemma 2: Candidate Monotonicity Functional (Sonin Majorant)
...
### Lemma 3: Turning Points and Sign Regimes
...
1. **No Turning Points ($0 \le \alpha, \beta < 1/2$):** Both boundary numerator coefficients $(1/4 - \alpha^2) > 0$ and $(1/4 - \beta^2) > 0$. The potential $Q(\theta)$ is unconditionally positive and diverges to $+\infty$ at both boundaries. The solution is strictly oscillatory globally.
2. **Turning Points Present ($\alpha \ge 1/2$ or $\beta \ge 1/2$):** At least one of the pole coefficients becomes negative. Consequently, $Q(\theta) \to -\infty$ near $\theta=0$ (if $\alpha > 1/2$) or $\theta=\pi$ (if $\beta > 1/2$). There exist internal turning points $\theta_t \in (0, \pi)$ where $Q(\theta_t) = 0$.

### Lemma 4: Full Proof in the Nontrivial Regime ($0 \le \alpha, \beta < 1/2$ and $n \ge 1$)
